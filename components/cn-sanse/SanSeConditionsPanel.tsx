  ...
  return (
    <div className="p-2.5 space-y-2">
      <div className="flex items-center gap-1.5 flex-wrap text-[11px]">
        ...
        {r.combo && <span className={cn('px-1.5 py-0.5 rounded border font-medium', COMBO_BADGE[r.combo.grade])} title="使用順序評級（回測推導：紅當前提 → 捕撈/雙B金叉觸發 → 紅紫黃全亮）">{COMBO_LABEL[r.combo.grade]}{r.combo.bottomReversal ? '·底部反彈' : ''}</span>}

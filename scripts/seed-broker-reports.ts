...
const SPECS: ReportSpec[] = [
  ...
  // ===== 中信投顧 今日台股盤勢重點 2026-06-11（盤勢/籌碼，點名股以「提及」追蹤）=====
  { report_id: '617915884052152339', broker: 'ctbc', broker_display: '中信', report_date: '2026-06-11',
    title: '今日台股盤勢重點 — 跌破月線、未站回 5 日線前審慎（盤勢/籌碼）', source_pdf: '617915884052152339_今日台股盤勢重點-CTBC260611.pdf',
    primary: null, parse_mode: 'text', stocks: [
      { raw: '尖點', code: '8021', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資買超 17.7 億；量價同增、股價創高。' },
      { raw: '大立光', code: '3008', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資買超 38.9 億；創高拉回。' },
      { raw: '蜜望實', code: '8043', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資買超 10.9 億；創高拉回。' },
      { raw: '台光電', code: '2383', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資買超 15.4 億。' },
      { raw: '台積電', code: '2330', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 353 億；跌破月均線。' },
      { raw: '台達電', code: '2308', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 157 億；跌破月均線。' },
      { raw: '國巨', code: '2327', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 53 億、投信買超 72 億（多空對作）；創高拉回。' },
      { raw: '力積電', code: '6770', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 49 億；跌破月均線。' },
      { raw: '鴻海', code: '2317', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 42 億；跌破月均線。' },
      { raw: '日月光投控', code: '3711', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 29 億；跌破月均線。' },
      { raw: '富邦媒', code: '8454', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '投信買超 12.9 億；連十紅。' },
      { raw: '廣達', code: '2382', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '投信買超 76.6 億；守住十日均線。' },
      { raw: '瑞昱', code: '2379', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '投信買超 16.6 億；站穩各均線上。' },
      { raw: '鈊象', code: '3293', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '投信買超 10.7 億；站穩各均線上。' },
      { raw: '中租-KY', code: '5871', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '投信買超 10 億；站穩各均線上。' },
      { raw: '凱基金', code: '2883', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資大賣 9.3 萬張、投信大買 9.4 萬張（多空對作）；站穩各均線上。' },
      { raw: '富邦金', code: '2881', rating_raw: '', target: null, prev: null, covered: false,
        thesis: '外資賣超 26.7 億、投信買超 25.4 億；站穩各均線上。' },
    ] },
];

 ...
 */
export async function fetchCnMainFlow(code: string, days = 200): Promise<Map<string, CnFlowDay>> {
  const url = `${FFLOW_API}?secid=${getSecid(code)}&klt=101&lmt=${days}` +

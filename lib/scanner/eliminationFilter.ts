 ...
 *   1.  沒走出底部（均線空排+股價月線下）         — ✅
 *   2.  重壓不過跌破 MA5                         — ✅
 *   3.  上漲一波後趨勢不明確（均線雜亂+震盪）    — ⚠️ 本檔未獨立實作（原 docblock 誤標 ✅）；精神＝「上有重壓下有支撐的區間震盪股不做多」已由 entryProhibitions 戒律7「盤整不做多」在進場側擋掉。若要獨立成淘汰 rule 需先過 compute-honest-edge（書-19，2026-07-07 勘誤）
 *   4.  沒有量能（量縮）                         — ✅

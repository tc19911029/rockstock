 ...
 * f6/f7/f8 = 硬汰弱事件（發生即淘汰）；f1~f4 = 資訊性旗標（收錄品質提醒）。
 *
 * ⚠️ 2026-07-20 第七輪查證：課程第 (5) 條「**區間振盪的股票**」目前**未實作**（本函式從 f4 跳到 f6）。
 * 舊註解寫「f1~f5」是錯的。未補的原因＝課程沒給「區間振盪」的量化定義，
 * 補上門檻會是自創值 → 依誠實 edge 紀律需先回測 + 使用者裁決，不逕自加。
 */

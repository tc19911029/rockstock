 ...
 *  2026-08-26 全 38 題材複核，校正 ASIC 並補齊 CoWoS／先進封裝／玻璃基板核心業者；
 *  2026-08-27 將 CPO、矽光子、光通訊收斂為公司正式揭露直接產品、平台或關鍵元件的核心名單）
 *
 ...
 *
 * 設計註記：
 * - 同一檔股票可屬多個題材（如 CPO 與矽光子、CoWoS設備與半導體設備）— 刻意保留，
 *   因此不可當作全市場互斥分類或拿來計算市場廣度
 * - CPO、矽光子、光通訊各自按直接產品定義，不強迫彼此維持子集合；通用代工、測試設備、
 *   伺服器 ODM 與只有間接受惠推測者不納入這三個核心名單
...
export const THEME_MAP: Record<string, ThemeStock[]> = {
  ...
  'CPO': [
    // 2026-08-27 核心名單：只收公司正式揭露的 CPO 平台、系統、光引擎／封裝與關鍵光學元件
    { code: '2330', name: '台積電' }, { code: '2345', name: '智邦' },
    { code: '3711', name: '日月光投控' }, { code: '6451', name: '訊芯-KY' },
    { code: '3363', name: '上詮' }, { code: '3163', name: '波若威' },
    { code: '6442', name: '光聖' }, { code: '4971', name: 'IET-KY' },
    { code: '4908', name: '前鼎' },
  ],
  '矽光子': [
    // 2026-08-27 核心名單：只收 SiPh 平台、PIC／光引擎、異質整合封裝及專用光源／耦光元件
    { code: '2330', name: '台積電' }, { code: '2345', name: '智邦' },
    { code: '3711', name: '日月光投控' }, { code: '6451', name: '訊芯-KY' },
    { code: '3363', name: '上詮' }, { code: '3163', name: '波若威' },
    { code: '6442', name: '光聖' }, { code: '4971', name: 'IET-KY' },
  ...
  '光通訊': [
    // 2026-08-27 核心名單：只收直接供應光晶片、光模組、光纖元件／電纜與光網通設備者
    { code: '2345', name: '智邦' },
    { code: '3081', name: '聯亞' }, { code: '4979', name: '華星光' },
    { code: '3363', name: '上詮' }, { code: '6442', name: '光聖' },
    { code: '3163', name: '波若威' }, { code: '4977', name: '眾達-KY' },
    { code: '6451', name: '訊芯-KY' }, { code: '3450', name: '聯鈞' },
    { code: '2455', name: '全新' }, { code: '3234', name: '光環' },
    { code: '4908', name: '前鼎' }, { code: '6530', name: '創威' },
    { code: '8011', name: '台通' }, { code: '4903', name: '聯光通' },
    { code: '6426', name: '統新' }, { code: '4971', name: 'IET-KY' },
